...
//	}
	...
	private void startResultSummaryTable(String style) {  //5.2.1
		...
		m_out.println("<tr><td bgcolor='white' colspan='4'> <table border='0' width='100%' bgcolor='#e6f7ff'><tr>"
				...
				+ "<center><img width='150px' src='https://dntinfotech.com/wp-content/uploads/2020/01/DNT-technology-1-147x80.png'/></center>"
		...
		m_out.println("<tr><td colspan='4'>Overall test suite completion : <b>"
				...
				+ sdf.format(date) + "</b><br/> Browser : <b> "+SeleniumInit.browserName+"<t></t> </b><br/>OS: <b>"
...
/*style the (+) and (-) */
	...
	protected void endHtml(PrintWriter out) {
		...
		out.println("<tr bgcolor='SkyBlue'><td align='right' colspan='4'><center><b><i>Report customized by DnTInfotech </i><b><center></center></b></b></center></td></tr>");

...
public class SearchProductIndex extends SeleniumInit {
	...
	public void searchProduct() throws Exception {
		...
		//Common.getURL(driver, "https://apptest.avasam.com/seeker.html#/productssearchproduct");
		test1.log(LogStatus.PASS, "Click on Search Product");
		 ...
		 Common.pause(2);
		  ...
		  test1.log(LogStatus.PASS, "Step " + (extentStepCount++) +
		  " : Search Product title");
		  
		  searchProductVerificationPage =
		  searchProductIndexPage.clickOnInputSearchProduct();
		  test1.log(LogStatus.PASS, "Search Product title");
		  
		  // Common.pause(4); searchProductVerificationPage =
		  searchProductIndexPage.mouseoverToSource();
		  
		  Common.pause(4);
		  
		  searchProductVerificationPage =
		  searchProductIndexPage.clickOnBtnSearchProduct(); Common.pause(2);
		  
		  boolean errorMessage =
		  searchProductVerificationPage.verifyProductAdded();
